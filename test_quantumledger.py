...
"""Tests for QuantumLedger."""

import pytest
from quantumledger import QuantumLedgerCore, QuantumLedger


class TestCore:
    def setup_method(self):
        self.core = QuantumLedgerCore(threshold=0.75)
    ...
    def test_threshold_respected(self):
        core = QuantumLedgerCore(threshold=0.99)
