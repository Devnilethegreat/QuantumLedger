...
class QuantumLedger:
    """Main orchestrator for QuantumLedger."""

    def __init__(self, verbose: bool = False):
        self.verbose = verbose
        self.threshold = float(os.getenv("THRESHOLD", "0.75"))
        self.core = QuantumLedgerCore(threshold=self.threshold, verbose=verbose)
    ...
    def run(self) -> bool:
        try:
            self.logger.info("Starting QuantumLedger processing pipeline")
...
def main():
    parser = argparse.ArgumentParser(description="QuantumLedger")
...
# revision 6 (2025-03-11): review pass

# revision 16 (2025-06-29): review pass
